        ...
        case 0x3c9:
            ...
            switch (svga->dac_pos) {
                ...
                case 2:
                    ...
                    /* The border is a live DAC lookup through attribute 11h, so
                       rewriting that entry recolours it. */
                    if (!svga->ext_overscan && (index == svga->attrregs[0x11]))
                        svga->overscan_color = svga->pallook[index];
                    svga->dac_pos  = 0;
